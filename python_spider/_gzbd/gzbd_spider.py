    ...
    try:
        ...
        if r.status_code == 200:
            ...
            for span in span_list:
                ...
                re_1 = re.search(line_re_1, line)
                re_2 = re.search(line_re_2, line)
                re_3 = re.search(line_re_3, line)
                re_4 = re.search(line_re_4, line)
                re_5 = re.search(line_re_5, line)
                re_6 = re.search(line_re_6, line)
                if re_1:
